...
export default function FloorhostingPage() {
  return (
    <CaseStudyLayout
      ...
      founderNote2="Every feature, from authentication to billing and service management, was built with the same care I bring to enterprise React applications."
